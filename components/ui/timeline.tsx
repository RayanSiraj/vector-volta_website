  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto pt-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-4xl md:text-8xl font-black mb-10 tracking-tighter leading-[0.9] text-[#121212] max-w-4xl">
          {headerTitle || "Our Process"}
        </h2>
        <p className="text-zinc-500 text-2xl font-bold max-w-2xl leading-relaxed">
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white flex items-center justify-center border border-zinc-100 shadow-sm">
                <div className="h-4 w-4 rounded-full bg-[#22c55e] border border-[#22c55e]" />
              </div>
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3 className="md:hidden block text-3xl mb-4 text-left font-black text-zinc-900 tracking-tighter">
                {item.title}
              </h3>
              {item.content}{" "}
            </div>
